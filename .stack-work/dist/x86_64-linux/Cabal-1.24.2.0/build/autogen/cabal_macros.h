...
/* package mogul-0.1.0.0 */
#define VERSION_mogul "0.1.0.0"
#define MIN_VERSION_mogul(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package parsec3-1.0.1.8 */
#define VERSION_parsec3 "1.0.1.8"
#define MIN_VERSION_parsec3(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "mogul-0.1.0.0-KefmOzrHo5AJyqeBDcMSes"

#define CURRENT_PACKAGE_KEY "mogul-0.1.0.0-KefmOzrHo5AJyqeBDcMSes"
